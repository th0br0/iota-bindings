...
import rs.iota.jni.util.Environment;

/**
 * This class is used to load the IOTA shared library from within the jar.
...
public class NativeLibraryLoader {
    ...
    private static final String sharedLibraryName = Environment.getSharedLibraryName("iota");
    private static final String jniLibraryName = Environment.getJniLibraryName("iota");
    private static final String jniLibraryFileName = Environment.getJniLibraryFileName("iota");
    private static final String tempFilePrefix = "libiotajni";
     ...
     * {@link NativeLibraryLoader#loadLibraryFromJar(java.lang.String)}
     *
    ...
    /**
     * Attempts to extract the native IOTA library
